...
def generate(model, tokenizer, prompt, max_new_tokens, temperature, top_k, device,
    ...
    with torch.no_grad():    # We're not training, don't track gradients
        for _ in range(max_new_tokens):
            ...
            # This fixes the low-entropy loops where a small model gets stuck
            # repeating the same token over and over (e.g., "Bitcoin.com / Bitcoin.com").
...
def main():
    ...
    print("Chat with MaxGPT-3. Type 'quit' to exit.\n")
